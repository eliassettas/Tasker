...
export class UserService {
  ...
  public registerUser(registrationRequest: RegistrationRequest): Observable<string> {
    return this.http.post<string>(`${this.apiURL}/registration`, registrationRequest, { responseType: 'text' as 'json' });
  }
  ...
  public updateUserImage(userId: number, image: File): Observable<string> {
    ...
    return this.http.put<string>(`${this.apiURL}/image`, formData, { params: httpParams, responseType: 'text' as 'json' });
  }
}
